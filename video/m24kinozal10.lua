		...
		if not m_simpleTV.Control.CurrentAddress:match('kinozal10') then return end
	...
	local pls = 'http://m24.do.am/CH/kino/kinozal10.txt'
...
tab.ExtParams = {}
	...
	m_simpleTV.OSD.ShowSelect_UTF8('M24 Фильм🎞️', plstIndex - 1, tab, 0, 64 + 256)
--	m_simpleTV.Control.ChangeAddress = 'Yes'
