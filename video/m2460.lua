		...
		if not m_simpleTV.Control.CurrentAddress:match('m2460') then return end
	...
	local pls = 'http://m24.do.am/CH/kino/m2460.txt'
...
tab.ExtParams.Random = 1
	...
	m_simpleTV.OSD.ShowSelect_UTF8('M24 Кино 60🎞️', plstIndex - 1, tab, 0, 64 + 256)
