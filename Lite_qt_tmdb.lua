--TMDb portal - lite version west_side 23.11.21
...
local function setConfigVal(key,val)
	...
	t0.ExtButton1 = {ButtonEnable = true, ButtonName = ' EX-FS '}
...
--------------
		...
		local ret, id = m_simpleTV.OSD.ShowSelect_UTF8(ru_name, 0, t1, 30000, 1 + 4 + 8 + 2)
		if ret == 1 then
			if id == 1 then
			media_info_tmdb(tmdbid,tv)
