...
if m_simpleTV.Control.Reason=='addressready' and m_simpleTV.Control.CurrentAddress:match('/main/video%d+%.mp4') and m_simpleTV.User.westSide.UP and m_simpleTV.User.westSide.UP == true then
...
if m_simpleTV.Control.Reason=='EndReached' and m_simpleTV.Control.CurrentAddress:match('/main/video%d+%.mp4') then
	if m_simpleTV.Control.MainMode == 0 then
		m_simpleTV.Interface.SetBackground({BackColor = 0, PictFileName = 'http://m24.do.am/SimpleTVupd/beckgr.jpg', TypeBackColor = 0, UseLogo = 4, Once = 1})
	end
	m_simpleTV.Control.Action = 'stop'
