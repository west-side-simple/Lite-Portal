...
local function checkApiKey(key)
	...
	if not m_simpleTV.User.YT.cookies then
		...
		m_simpleTV.User.YT.Lng.country = 'UA' or cookies:match('gl=([^&;]+)') or m_simpleTV.User.YT.Lng.country
	end

	-----------------
--	getApiKey()
	m_simpleTV.User.YT.apiKey = ''
	-----------------
...
function getstart(vid_cat_id, pageToken)
	...
	local url = 'https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&hl=' .. m_simpleTV.User.YT.Lng.lang .. '&maxResults=28&regionCode=' .. 'UA' .. '&videoCategoryId=' .. vid_cat_id .. '&key=' .. m_simpleTV.User.YT.apiKey .. '&pageToken=' .. pageToken
