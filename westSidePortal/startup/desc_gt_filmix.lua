--Filmix desc west_side 15.05.25
...
-- serials
		...
		{"https://filmix.my/top250s/","TOP сериалы Filmix"},
		...
		{"https://filmix.my/top250m/","TOP мульты Filmix"},
...
function tooltip_filmix_WS(ObjectName,EventName,data)
	...
	if ObjectName:match('MOVIE_IMG') then
		mes = 'Фильмы'
		x = 90
		y = 140
	end
	if ObjectName:match('TV_IMG') then
		mes = 'Сериалы'
		x = 170
		y = 140
	end
	if ObjectName:match('MULT_IMG') then
		mes = 'Мульты'
		x = 250
		y = 140
	end
	if ObjectName:match('MULTSERIAL_IMG') then
		mes = 'Мультсер.'
		x = 330
		y = 140
	end
	...
	if ObjectName:match('SEARCH_CONTENT_FILMIX_IMG') then
		mes = 'Поиск ⟲'
		x = 410
		y = 140
		align = 0x0103
...
--				 t.backcolor1 = 0x77FFFFFF
				...
				t.borderround = 20
				t.mouseMoveEventFunction = 'tooltip_filmix_WS'
