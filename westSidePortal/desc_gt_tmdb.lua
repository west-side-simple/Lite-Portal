...
function stena()
	...
	local kx, ky = m_simpleTV.Config.GetValue("mainOsd/scaleResolution","simpleTVConfig")
	kx = tonumber(kx)/1920
	ky = tonumber(ky)/1080
...
-- for del
			m_simpleTV.User.TVPortal.stena.balanser2 = nil -- del Videocdn
--			m_simpleTV.User.TVPortal.stena.balanser3 = nil -- del Zetflix
			m_simpleTV.User.TVPortal.stena.balanser4 = nil -- del CDNMoovie
--			m_simpleTV.User.TVPortal.stena.balanser5 = nil -- del HDVB
--			m_simpleTV.User.TVPortal.stena.balanser6 = nil -- del Collaps
--			m_simpleTV.User.TVPortal.stena.balanser7 = nil -- del Kodik
--			m_simpleTV.User.TVPortal.stena.balanser8 = nil -- del ASHDI
--			m_simpleTV.User.TVPortal.stena.balanser9 = nil -- del FXLite
			m_simpleTV.User.TVPortal.stena.balanser10 = nil --VideoDB
--			m_simpleTV.User.TVPortal.stena.balanser11 = nil --FanCDN
...
--			 t.backcolor1 = 0x77FFFFFF
			 ...
			 AddElement(t,'ID_DIV_STENA_1')
--todo
			if m_simpleTV.User.TVPortal.stena.banner and m_simpleTV.User.TVPortal.stena.banner.img then
			 local dx = 900
			 local dy = 900/m_simpleTV.User.TVPortal.stena.banner.width*m_simpleTV.User.TVPortal.stena.banner.height
			 if dy > 180 then
			  dy = 180
			  dx = 180/m_simpleTV.User.TVPortal.stena.banner.height*m_simpleTV.User.TVPortal.stena.banner.width
			 end
			 t = {}
			 t.id = 'USER_BANNER_IMG_STENA_1_ID'
			 t.cx= dx
			 t.cy= dy
			 t.class="IMAGE"
			 t.imagepath = m_simpleTV.User.TVPortal.stena.banner.img
			 t.minresx=-1
			 t.minresy=-1
			 t.align = 0x0103
			 t.left=20
...
--			 t.imagepath = m_simpleTV.MainScriptDir_UTF8 .. 'user/show_mi/pause/empty.png'
			 ...
			 t.backroundcorner = 5*5
			 t.borderround = 5
			 t.mousePressEventFunction = 'change_trackers'
			 AddElement(t,'ID_DIV_STENA_1')
			 ...
			 t.cy= 110 / 1*1.25
			 t.class="IMAGE"
			 if m_simpleTV.User.TVPortal.stena.trackers then
...
--			m_simpleTV.User.TVPortal.stena.balanser1 = true
			...
			if m_simpleTV.User.TVPortal.stena.balanser12 then

			 t = {}
			 t.id = 'BALANSER12_IMG_STENA_BACK_ID'
			 t.cx= 90 / 1*1.25
			 t.cy= 60 / 1*1.25
			 t.class="IMAGE"
			 t.imagepath = m_simpleTV.MainScriptDir_UTF8 .. 'user/show_mi/pause/empty.png'
			 ...
			 t.backroundcorner = 3*3
			 t.borderround = 3
			 t.mousePressEventFunction = 'play_balanser12'
			 AddElement(t,'ID_DIV_STENA_1')

			 t = {}
			 t.id = 'BALANSER12_IMG_STENA_ID'
			 t.cx= 80 / 1*1.25
			 t.cy= 80 / 1*1.25
			 t.class="IMAGE"
...
--			if m_simpleTV.User.TVPortal.stena.balanser3 == '' then
			 ...
			 t.transparency = 200
			 t.zorder=2
--			 AddElement(t,'BALANSER3_IMG_STENA_BACK_ID')
--			end
...
--			m_simpleTV.User.TVPortal.stena.balanser4 = true
			...
			if m_simpleTV.User.TVPortal.stena.balanser4 then
			 ...
			 t.transparency = 200
			 t.zorder=0
			 t.borderwidth = Get_current_balanser_name('CDN Movies')
			 t.bordercolor = -6250336
			 t.backroundcorner = 3*3
			 t.borderround = 3
			 t.isInteractive = true
			 ...
			 t.cy= 80 / 1*1.25
			 t.class="IMAGE"
			 t.imagepath = m_simpleTV.MainScriptDir_UTF8 .. 'user/show_mi/pause/CDNmovies.png'
			 t.minresx=-1
			 t.minresy=-1
			 t.align = 0x0103
			 t.left= (add + 5) / 1*1.25
...
--			m_simpleTV.User.TVPortal.stena.balanser9 = true

			if m_simpleTV.User.TVPortal.stena.balanser9 then

			 t = {}
			 t.id = 'BALANSER9_IMG_STENA_BACK_ID'
			 t.cx= 90 / 1*1.25
			 t.cy= 60 / 1*1.25
			 t.class="IMAGE"
			 t.imagepath = m_simpleTV.MainScriptDir_UTF8 .. 'user/show_mi/pause/empty.png'
			 ...
			 t.backroundcorner = 3*3
			 t.borderround = 3
			 t.mousePressEventFunction = 'play_balanser9'
			 AddElement(t,'ID_DIV_STENA_1')

			 t = {}
			 t.id = 'BALANSER9_IMG_STENA_ID'
			 t.cx= 80 / 1*1.25
			 t.cy= 80 / 1*1.25
			 t.class="IMAGE"
...
--			AddElement(t,'ID_DIV_STENA_1')
			...
			if m_simpleTV.User.TVPortal.stena.balanser10 then

			 t = {}
			 t.id = 'BALANSER10_IMG_STENA_BACK_ID'
			 t.cx= 90 / 1*1.25
			 t.cy= 60 / 1*1.25
			 t.class="IMAGE"
			 t.imagepath = m_simpleTV.MainScriptDir_UTF8 .. 'user/show_mi/pause/empty.png'
			 ...
			 t.backroundcorner = 3*3
			 t.borderround = 3
			 t.mousePressEventFunction = 'play_balanser10'
			 AddElement(t,'ID_DIV_STENA_1')

			 t = {}
			 t.id = 'BALANSER10_IMG_STENA_ID'
			 t.cx= 80 / 1*1.25
			 t.cy= 80 / 1*1.25
			 t.class="IMAGE"
...
--			AddElement(t,'ID_DIV_STENA_1')
			...
			if m_simpleTV.User.TVPortal.stena.balanser11 then

			 t = {}
			 t.id = 'BALANSER11_IMG_STENA_BACK_ID'
			 t.cx= 90 / 1*1.25
			 t.cy= 60 / 1*1.25
			 t.class="IMAGE"
			 t.imagepath = m_simpleTV.MainScriptDir_UTF8 .. 'user/show_mi/pause/empty.png'
			 ...
			 t.backroundcorner = 3*3
			 t.borderround = 3
			 t.mousePressEventFunction = 'play_balanser11'
			 AddElement(t,'ID_DIV_STENA_1')

			 t = {}
			 t.id = 'BALANSER11_IMG_STENA_ID'
			 t.cx= 80 / 1*1.25
			 t.cy= 80 / 1*1.25
			 t.class="IMAGE"
			 t.imagepath = m_simpleTV.MainScriptDir_UTF8 .. 'user/show_mi/pause/VideoDB.png'
...
--			 t.borderwidth = 2
			 ...
			 t.backroundcorner = 3*3
			 t.borderround = 3
			 t.mousePressEventFunction = 'search_exfs_from_tmdb'
			 AddElement(t,'ID_DIV_STENA_1')

			 t = {}
			 t.id = 'EXFS_TEXT_STENA_ID'
			 t.cx= 60 / 1*1.25
			 t.cy= 60 / 1*1.25
			 t.class="TEXT"
			 t.text = "EX-FS"
			 t.color = ARGB(212, 192, 192, 192)
			t.font_height = -14 / m_simpleTV.Interface.GetScale()*1.5
			t.font_weight = 200 / m_simpleTV.Interface.GetScale()*1.5
			t.font_name = "Segoe UI Black"
			t.textparam = 0x00000001
...
--			 AddElement(t,'ID_DIV_STENA_1')
			 ...
			 t = {}
			 t.id = 'EXFS_IMG_STENA_ID'
			 t.cx= 60 / 1*1.25
			 t.cy= 60 / 1*1.25
			 t.class="IMAGE"
			 t.imagepath = m_simpleTV.MainScriptDir_UTF8 .. 'user/show_mi/pause/EX-FS.png'
			 t.minresx=-1
			 t.minresy=-1
			 t.align = 0x0101
			 t.left= (170+400) / 1*1.25
...
function show_info_tmdb()
	return media_info_tmdb(m_simpleTV.User.TVPortal.tmid, m_simpleTV.User.TVPortal.tv)
end
--- end for pause menu
...
function play_balanser12()
	...
	m_simpleTV.Control.PlayAddressT({address='tmdb_id=' .. m_simpleTV.User.TMDB.Id .. '&tv=' .. m_simpleTV.User.TMDB.tv .. '&' .. m_simpleTV.User.TVPortal.stena.balanser12, title=m_simpleTV.User.TVPortal.stena.title .. ' (' .. m_simpleTV.User.TVPortal.stena.year .. ')'})
end
...
function play_balanser11()
	...
	if not m_simpleTV.User.TVPortal.fcdn then
		m_simpleTV.User.TVPortal.fcdn = {}
	end
	if #m_simpleTV.User.TVPortal.stena.balanser11 > 1 then
		m_simpleTV.User.TVPortal.stena.balanser11.ExtButton0 = {ButtonEnable = true, ButtonName = 'Контент '}
		local ret, id = m_simpleTV.OSD.ShowSelect_UTF8('🔊 Озвучка FCDN', (tonumber(m_simpleTV.User.TVPortal.fcdn.transl_selected) or 1) - 1, m_simpleTV.User.TVPortal.stena.balanser11, 10000, 1 + 4 + 8 + 2)
		id = id or 1
		if ret == 1 then
			m_simpleTV.User.TVPortal.fcdn.transl_selected = id
			m_simpleTV.Control.PlayAddressT({address='tmdb_id=' .. m_simpleTV.User.TMDB.Id .. '&tv=' .. m_simpleTV.User.TMDB.tv .. '&' .. m_simpleTV.User.TVPortal.stena.balanser11[id].Address, title=m_simpleTV.User.TVPortal.stena.title .. ' (' .. m_simpleTV.User.TVPortal.stena.year .. ') - ' .. m_simpleTV.User.TVPortal.stena.balanser11[id].Name})
		end
		if ret == 2 then
			tmdb_info()
		end
	else
		m_simpleTV.Control.PlayAddressT({address='tmdb_id=' .. m_simpleTV.User.TMDB.Id .. '&tv=' .. m_simpleTV.User.TMDB.tv .. '&' .. m_simpleTV.User.TVPortal.stena.balanser11[1].Address, title=m_simpleTV.User.TVPortal.stena.title .. ' (' .. m_simpleTV.User.TVPortal.stena.year .. ') - ' .. m_simpleTV.User.TVPortal.stena.balanser11[1].Name})
	end
end
...
function play_balanser9()
	...
	m_simpleTV.Control.PlayAddressT({address='tmdb_id=' .. m_simpleTV.User.TMDB.Id .. '&tv=' .. m_simpleTV.User.TMDB.tv .. '&' .. m_simpleTV.User.TVPortal.stena.balanser9, title=m_simpleTV.User.TVPortal.stena.title .. ' (' .. m_simpleTV.User.TVPortal.stena.year .. ')'})
end

function play_balanser10()
	m_simpleTV.User.TVPortal.is_stena = false
	m_simpleTV.User.TVPortal.stena_use = false
	m_simpleTV.User.TVPortal.stena_info = false
	m_simpleTV.User.TVPortal.stena_home = false
	...
	m_simpleTV.Control.PlayAddressT({address='tmdb_id=' .. m_simpleTV.User.TMDB.Id .. '&tv=' .. m_simpleTV.User.TMDB.tv .. '&' .. m_simpleTV.User.TVPortal.stena.balanser10, title=m_simpleTV.User.TVPortal.stena.title .. ' (' .. m_simpleTV.User.TVPortal.stena.year .. ')'})
end
...
function search_exfs_from_tmdb()
	m_simpleTV.Config.SetValue('search/media',m_simpleTV.Common.toPercentEncoding(m_simpleTV.User.TVPortal.stena.title),'LiteConf.ini')
	add_to_history_of_search()
	search_media()
end
...
function change_trackers()
	if m_simpleTV.User.TVPortal.stena.trackers == true then
		m_simpleTV.User.TVPortal.stena.trackers = false
	else
		m_simpleTV.User.TVPortal.stena.trackers = true
	end
	tmdb_info_for_stena(m_simpleTV.User.TMDB.Id,m_simpleTV.User.TMDB.tv)
end
...
function stena_callback(typeEvent)
	...
	elseif typeEvent and tonumber(typeEvent) == 1 and m_simpleTV.User.TVPortal and m_simpleTV.User.TVPortal.stena_filmix_info then
		filmix_info()
	elseif typeEvent and tonumber(typeEvent) == 1 and m_simpleTV.User.TVPortal and m_simpleTV.User.TVPortal.stena_rezka_use then
		stena_rezka()
	elseif typeEvent and tonumber(typeEvent) == 1 and m_simpleTV.User.TVPortal and m_simpleTV.User.TVPortal.stena_rezka_info then
		rezka_info()
	...
	elseif typeEvent and tonumber(typeEvent) == 1 and m_simpleTV.User.TVPortal and m_simpleTV.User.TVPortal.stena_exfs_use then
		create_stena_for_exfs()
	elseif typeEvent and tonumber(typeEvent) == 1 and m_simpleTV.User.TVPortal and m_simpleTV.User.TVPortal.stena_imdb_use then
		create_stena_for_imdb()
	elseif typeEvent and tonumber(typeEvent) == 1 and m_simpleTV.User.TVPortal and m_simpleTV.User.TVPortal.stena_exfs_info then
		info_exfs()
	end
end
...
function stena_clear()
	...
	m_simpleTV.User.TVPortal.stena_imdb_use = false
...
function onActionEsc(action, param)
 ...
 if (esc_action_id) then
	...
	if westSidePortalDialogRequestClose then
	westSidePortalDialogRequestClose()
	end
 else
