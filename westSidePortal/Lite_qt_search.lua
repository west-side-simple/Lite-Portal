-- Плагин поиска для lite portal - west_side 27.06.25
...
function search_media()
	...
	m_simpleTV.User.EXFS.stena_exfs_type = 'search'
	...
	m_simpleTV.User.EXFS.stena_exfs_title = 'Найдено EX-FS: ' .. m_simpleTV.Common.fromPercentEncoding(search_ini) .. ' (' .. #t .. ')'
