...
-- author west_side 15.05.23
	...
	function OnNavigateComplete(Object)
		...
		m_simpleTV.Dialog.SetCheckBoxValue(Object,'AudioWS_Hot',value)
	...
	function OnOk(Object)
		...
		value=m_simpleTV.Dialog.GetCheckBoxValue(Object,'AudioWS_Hot')
		if value ~= nil then
			setConfigVal("AudioWS_Hot",value)
