...
pcall (dofile,m_simpleTV.MainScriptDir .. "user/Radio/stationspatterns.lua")
...
m_simpleTV.OSD.AddEventListener({type=1,callback="radioOsdEvent"})
  ...
  t.ctrlkey = 2
  t.location = 0
  t.imageSubmenu = m_simpleTV.MainScriptDir_UTF8 .. 'user/Radio/pic/radioicon.png'
 ...
 value = getConfigVal("RadioUseExtraFilter")
 if value~=nil then
    if tonumber(value) == 1 then 
         m_simpleTV.User.Radio.RadioUseExtraFilter = true
      elseif tonumber(value) == 0 then
         m_simpleTV.User.Radio.RadioUseExtraFilter = false
   end
 end
 ...
 value=getConfigVal('radioMusicLayout') 
  if value~=nil then
	 ...
	 elseif value==7 then
            m_simpleTV.User.Radio.Layout=7		
         end         
  end
...
m_simpleTV.User.Radio.RadioScrollTextLayout6=value
  ...
  --layout 7
value = getConfigVal("RadioTrackFontLayout7") or 'constantia,40,-1,5,70,0,0,0,0,0'
m_simpleTV.User.Radio.RadioTrackFontLayout6=value

value = getConfigVal("RadioStationFontLayout7") or 'constantia,30,-1,5,70,0,0,0,0,0'
m_simpleTV.User.Radio.RadioStationFontLayout6 = value

value = getConfigVal("RadioTrackNumBreakLayout7") or 50
m_simpleTV.User.Radio.RadioTrackNumBreakLayout6=value

value = getConfigVal("RadioTextColorLayout7") or 'ffe8e8e8'
m_simpleTV.User.Radio.RadioTextColorLayout6=value
value = getConfigVal("RadioBorderColorLayout7") or 'ffe8e8e8'
m_simpleTV.User.Radio.RadioBorderColorLayout6=value  

value = getConfigVal("RadioBlurBgLayout7") or 10
m_simpleTV.User.Radio.RadioBlurBgLayout6=value
value = getConfigVal("RadioScrollTextLayout7") or 0
m_simpleTV.User.Radio.RadioScrollTextLayout6=value
