-- скрапер TVS для загрузки плейлиста "Filmax TV" (21/11/21)
...
-- ##
	...
	function GetSettings()
	 return {name = my_src_name, sortname = '', scraper = '', m3u = 'out_' .. my_src_name .. '.m3u', logo = 'https://cp.filmax-tv.ru/templates/FilmaxTV/images/favicon.png', TypeSource = 1, TypeCoding = 1, DeleteM3U = 1, RefreshButton = 1, AutoBuild = 0, AutoBuildDay = {0, 0, 0, 0, 0, 0, 0}, LastStart = 0, TVS = {add = 0, FilterCH = 1, FilterGR = 1, GetGroup = 1, LogoTVG = 1}, STV = {add = 1, ExtFilter = 1, FilterCH = 1, FilterGR = 1, GetGroup = 1, HDGroup = 0, AutoSearch = 1, AutoNumber = 0, NumberM3U = 0, GetSettings = 1, NotDeleteCH = 0, TypeSkip = 1, TypeFind = 1, TypeMedia = 0, RemoveDupCH = 0}}
	end
	function GetVersion()
	 return 2, 'UTF-8'
	end
	local function LoadFromSite()
		...
		m_simpleTV.OSD.ShowMessageT({imageParam = 'vSizeFactor="1.0" src="https://cp.filmax-tv.ru/templates/FilmaxTV/images/favicon.png"', text = ' Внесите данные в менеджере паролей для ID filmax', color = ARGB(255, 255, 255, 255), showTime = 1000 * 60})
		else
