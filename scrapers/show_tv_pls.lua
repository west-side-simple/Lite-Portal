-- скрапер TVS для загрузки плейлиста "ТВ Шоу" (13/01/22)
-- base script nexterr, mod west_side
-- ## необходим ##
-- видоскрипт: videocdn.lua
-- ##
	module('show_tv_pls', package.seeall)
	local my_src_name = 'ТВ Шоу'
	...
	local function LoadFromSite()
		...
		local t, i = {}, 1
			...
			for c = 1, 600 do
				...
				local url = string.format(decode64('aHR0cHM6Ly92aWRlb2Nkbi50di9hcGkvc2hvdy10di1zZXJpZXM/YXBpX3Rva2VuPVcyTnZMODZhMzRLZzJvSlhNVGY4cTY3Z3Nna0t1emFwJmxpbWl0PTI1JnBhZ2U9JXM='), c)
