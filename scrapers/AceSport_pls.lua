-- скрапер TVS для загрузки спортконтента плейлиста "AceStream" плюс бродкаст (27/11/24)
...
-- ##
	...
	module('AceSport_pls', package.seeall)
	local my_src_name = 'AceSport'
...
--	debug_in_file(answer .. '\n')
		...
		local t, i = {}, 1
			...
			t[#t+1] = t[1]
			t[1].address = 'https://myfootball.top/'
			t[1].name = 'MF.TOP on Ace'
			t[1].logo = 'https://downloadr2.apkmirror.com/wp-content/uploads/2024/02/83/65cc9785be0a3_org.acestream.node-384x384.png'
			t[1].group = 'sport broadcasting'

			t[#t+2] = t[2]
			t[2].address = 'https://www.pimpletv.ru'
			t[2].name = 'Pimple on Ace'
			t[2].logo = 'https://downloadr2.apkmirror.com/wp-content/uploads/2024/02/83/65cc9785be0a3_org.acestream.node-384x384.png'
			t[2].group = 'sport broadcasting'

			local hash, t0 = {}, {}
			for j = 1, #t do
				if t[j] and t[j].group and t[j].group:match('sport') then
