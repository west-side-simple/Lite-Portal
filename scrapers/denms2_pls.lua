-- скрапер TVS для загрузки плейлиста "DENMS TV - gelow74" http://denms.tplinkdns.com/ (10/06/21)
...
-- ##
	...
	module('denms2_pls', package.seeall)
	local my_src_name = 'DENMS TV - gelow74 (A)'
