-- скрапер TVS для загрузки плейлиста "Аниме" (13/01/22)
-- base script nexterr, mod west_side
-- ## необходим ##
-- видоскрипт: videocdn.lua
-- ##
	module('animes_pls', package.seeall)
	local my_src_name = 'Аниме'
	...
	local function LoadFromSite()
		...
		local t, i = {}, 1
			...
			for c = 1, 600 do
				...
				local url = string.format(decode64('aHR0cHM6Ly92aWRlb2Nkbi50di9hcGkvYW5pbWVzP2FwaV90b2tlbj1XMk52TDg2YTM0S2cyb0pYTVRmOHE2N2dzZ2tLdXphcCZsaW1pdD0yNSZwYWdlPSVz'), c)
